  ...
  return (
    <section className="relative px-4 md:px-6 pb-20">
      <motion.div
        ...
        className="mx-auto max-w-7xl rounded-3xl border-2 border-brand-dark bg-brand-pink text-white p-10 md:p-16 shadow-[10px_10px_0_0_hsl(var(--brand-dark))] noise relative overflow-hidden"
      >
        <div className="grid md:grid-cols-[1fr_auto] gap-6 items-center">
          <div className="space-y-3">
            <p className="font-display uppercase text-sm tracking-widest text-white/80">
              Custom Orders
            </p>
