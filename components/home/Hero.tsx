    ...
    <section className="relative overflow-hidden border-b-2 border-brand-dark bg-brand-cream noise">
      ...
      <div className="relative mx-auto max-w-7xl px-4 md:px-6 pt-16 md:pt-24 pb-20 md:pb-28 text-center">
        ...
        <motion.div
          ...
          className="mt-5 md:mt-0 mb-14 md:mb-20 mx-auto w-[88%] md:w-[78%] max-w-4xl"
          aria-label="SUPDAWG!"
        >
        ...
        >
          Digitizing logos, lettering, and artwork.
          Send a sketch or file and I&apos;ll get it ready to embroider!
        </motion.p>
